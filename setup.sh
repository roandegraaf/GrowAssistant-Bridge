...
show_success_banner() {
    ...
    echo ""
    echo -e "${GREEN}════════════════════════════════════════════════════════════════${NC}"
    echo -e "${GREEN}  ✓ GrowAssistant Bridge is running!${NC}"
    echo -e "${GREEN}════════════════════════════════════════════════════════════════${NC}"
    echo ""
    echo -e "  ${BOLD}Access your dashboard at:${NC}"
    echo ""
    echo -e "    ${CYAN}• http://${IP_ADDRESS}:${WEB_PORT}${NC}"
    echo -e "    ${CYAN}• http://${HOSTNAME}:${WEB_PORT}${NC}"
    echo -e "    ${CYAN}• http://${HOSTNAME}.local:${WEB_PORT}${NC}"
    echo ""
    echo -e "  ${BOLD}Login credentials:${NC}"
    echo -e "    Username: ${YELLOW}${WEB_USERNAME}${NC}"
...
show_manual_start_instructions() {
    ...
    echo -e "${GREEN}════════════════════════════════════════════════════════════════${NC}"
    echo ""
    echo -e "  ${BOLD}To start GrowAssistant Bridge:${NC}"
    echo ""
    ...
    echo ""
    echo -e "  ${BOLD}Your dashboard will be available at:${NC}"
    echo ""
    echo -e "    ${CYAN}• http://${IP_ADDRESS}:${WEB_PORT}${NC}"
    echo -e "    ${CYAN}• http://${HOSTNAME}:${WEB_PORT}${NC}"
    echo -e "    ${CYAN}• http://${HOSTNAME}.local:${WEB_PORT}${NC}"
